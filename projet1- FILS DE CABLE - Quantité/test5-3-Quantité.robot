...
Resource            ../PO/Choose5-3_Quantite.robot
...
Cables et fils electrique-Fils de cable
                ...
                Choose5-3_Quantite.clicker sur un produit et voir le panier             ${clicker_Produit}     ${Ajout_Panier}        ${Voirr_Panier}
                Choose5-3_Quantite.Eliminer le produit (0 Produits)                     ${Soustracter_nbr_produit}    ${Mettre_à_jour_panier}      ${Retour_à_la_boutique}
